...
def delete_packages_for_destination():
    all_packages = []
    op.add_package(all_packages, "01-07-2022", "06-07-2022", "Paris", 1000)
    op.add_package(all_packages, "01-07-2022", "06-07-2022", "Paris", 1000)
    op.add_package(all_packages, "01-07-2022", "06-07-2022", "Tokyo", 1000)
...
def print_packages_for_destination_and_price():
    all_packages = []
    op.add_package(all_packages, "01-01-2022", "01-01-2022", "Paris", 500)
    op.add_package(all_packages, "01-01-2022", "01-01-2022", "Paris", 700)
    op.add_package(all_packages, "01-01-2022", "01-01-2022", "Bucharest", 200)
